...
tinymce.init({
    selector: '#message',
    content_css: 'https://cdn.jsdelivr.net/gh/zhidd/11@3/huux_tinymce/tinymce/style.css', // 编辑内容区附加css文件
    language_url: 'https://cdn.jsdelivr.net/gh/zhidd/11@3/huux_tinymce/tinymce/langs/zh_CN.js', // 本地化中文语言包
    ...
    plugins: [ 'image',    'xiunoimgup'], // 加载的插件，-为禁用
    toolbar: ['   styleselect | formatting fontcolor   | alignment | imgup link       ' ], // 界面按钮
